        ...
        <div className="container py-14 md:py-20">
          ...
          <article className="mx-auto max-w-3xl space-y-8">
            <section>
              ...
              <p className="mt-2 text-muted-foreground">Überblick über häufige Beschwerdebilder.</p>
              <CollapsibleText collapsedHeight={0} moreLabel="alles anzeigen">
            ...
            <section>
              ...
              <p className="mt-2 text-muted-foreground">Kurzzeit-, analytische, akut- und tiefenpsychologisch fundierte Psychotherapie im Überblick.</p>
              <CollapsibleText collapsedHeight={0} moreLabel="alles anzeigen">
            ...
            <section>
              ...
              <p className="mt-2 text-muted-foreground">Psychodynamische Psychotherapie – wissenschaftlich anerkannt.</p>
              <CollapsibleText collapsedHeight={0} moreLabel="alles anzeigen">
            ...
            <section>
              ...
              <p className="mt-2 text-muted-foreground">Von der Anfrage bis zur Kostenklärung – das Wichtigste im Überblick.</p>
              <CollapsibleText collapsedHeight={0} moreLabel="alles anzeigen">
                <div className="mt-4 space-y-4 text-muted-foreground leading-relaxed">
                  <div>
