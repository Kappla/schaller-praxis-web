...
const Index = () => {
  return <main>
      <SEO title="Praxis für Psychotherapie Schaller" description="Psychotherapeutische Schaller Psychotherapie – Hilfe bei Angst, Depression, Stress und Lebenskrisen. Vertraulich, wirksam, auf Augenhöhe." path="/" />
