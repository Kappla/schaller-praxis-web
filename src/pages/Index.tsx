    ...
    <main>
        ...
        <div className="container py-14 md:py-20">
          ...
          <article className="mx-auto max-w-3xl space-y-8">
            ...
            <section>
              ...
              <CollapsibleText collapsedHeight={12}>
                <p className="text-muted-foreground">Analytische und tiefenpsychologisch fundierte Psychotherapie gehören neben der Verhaltenstherapie und der Systemischen Therapie zu den anerkannten Richtlinienverfahren, die wissenschaftlich fundiert sind und vom Bundesausschuss der Ärzte und Krankenkassen als Behandlungsverfahren anerkannt werden. Diese Verfahren werden in der Regel von den Krankenkassen übernommen.</p>
                <p className="text-muted-foreground">Beide Verfahren gehören zur psychodynamischen Psychotherapie und basieren auf den theoretischen Konzepten der Psychoanalyse. Dieser Ansatz geht davon aus, dass psychische Probleme und Störungen häufig mit der eigenen Lebensgeschichte in Verbindung stehen und insbesondere im Kontext vergangener und gegenwärtiger Beziehungserfahrungen betrachtet werden.</p>
                <p className="text-muted-foreground">Unsere Persönlichkeit und psychischen Strukturen werden maßgeblich durch Beziehungen geformt. Die verinnerlichten Beziehungserfahrungen prägen unser Selbstbild, unsere Wahrnehmung der Welt und unser Handeln – auch in herausfordernden Lebenssituationen oder Konflikten. Oft zeigt sich, dass Reaktionsmuster, die einst sinnvoll und hilfreich waren, im späteren Leben hinderlich werden können. Sie können zu psychischen Beschwerden führen und das eigene Erleben sowie Beziehungen belasten.</p>
                <p className="text-muted-foreground">In der gemeinsamen Arbeit geht es darum, diese verinnerlichten Muster bewusst zu machen, ein tieferes Verständnis für sich selbst bzw. des Verhaltens und Erlebens zu entwickeln. Ziel der Behandlung ist es, rigide Beziehungs- und Selbstmuster aufzubrechen und eine flexiblere, lebendigere psychische Struktur zu fördern. Voraussetzung für eine psychodynamische Psychotherapie ist das Interesse, sich mit dem eigenen Innenleben auseinanderzusetzen, die Hintergründe der eigenen Symptome verstehen zu wollen und an persönlicher Entwicklung zu arbeiten. So kann Veränderung im Hier und Jetzt ermöglicht und neue Wege aus belastenden Situationen gefunden werden.</p>
                <p className="text-muted-foreground">Die Dauer der Behandlung hängt von der Schwere und dem Verlauf der Problematik aber auch den individuellen Zielen ab und lässt sich daher nicht genau vorhersagen. Grundsätzlich ist es sinnvoll, sich darauf einzustellen, dass die Sitzungen über einen längeren Zeitraum Teil des Alltags sein können. In manchen Fällen zeigen sich bereits in einer Kurzzeit- oder Akuttherapie spürbare Fortschritte. Falls erforderlich, kann die Therapie in eine Langzeitbehandlung umgewandelt werden.</p>
              </CollapsibleText>
            </section>
            <section>
              ...
              <div className="mt-4 space-y-4 text-muted-foreground">
                ...
                <div>
                  ...
                  <CollapsibleText collapsedHeight={10}>
      ...
      <section id="ueber-mich">
        <div className="container py-14 md:py-20">
          ...
          <CollapsibleText collapsedHeight={16}>
